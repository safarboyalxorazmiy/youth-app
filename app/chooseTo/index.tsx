        ...
        renderItem={({ item, index }) => (
          <View style={{
            ...
            <Pressable
              onPress={() => {
                if (userLanguage == "uz") {
                  AsyncStorage.setItem("locationTo", (item.locationRegionUz == null ? "" : item.locationRegionUz));
                } else if (userLanguage == "ru") {
                  AsyncStorage.setItem("locationTo", (item.locationRegionRu == null ? "" : item.locationRegionRu));
                } else {
                  AsyncStorage.setItem("locationTo", (item.locationRegionCy == null ? "" : item.locationRegionCy));
                }
