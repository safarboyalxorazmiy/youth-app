...
export function StudyingInUzbekistanDropdown({
  selectedStatus,
  setSelectedStatus,
}: {
  ...
  const toggleDropdown = () => {
    ...
    setIsOpen(opening);
    dropdownHeight.value = withTiming(opening ? (employStatus.length + 1) * 44 : 0, {
      duration: 200,
        ...
        <FlatList
          ...
          ListHeaderComponent={() => 
            selectedStatus.title != "" && (
              <View style={{ alignItems: 'flex-end', justifyContent: 'center', backgroundColor: '#FBFBFB', height: 44, paddingHorizontal: 12 }}>
                <Text style={styles.itemText}>O'zbekistonda Ishlash</Text>
              </View>
            )   
          }
          renderItem={({ item }) => (
